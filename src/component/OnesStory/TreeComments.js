...
const TreeComments = ({match, history}) => {
     console.log(match)
    ...
    useEffect(() => {
        dispatch(fetchComments(8863)) // 8863  2921983
    }, [dispatch])
    ...
    return (
        ...
        <div className="h-screen bg-white dark:bg-gray-900">
            <Navbar title = "More information about ones interesting story" idComment = {8863} updateFetch={fetchComments} back = {history.goBack} isAutoUpdate={isAutoUpdate} setIsAutoUpdate={setIsAutoUpdate}></Navbar>
